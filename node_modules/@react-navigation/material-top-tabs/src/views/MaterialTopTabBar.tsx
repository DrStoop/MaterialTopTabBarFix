...
//   color: string;
//   labelText?: string | ((props: { focused: boolean, color: string, children: string }) => React.ReactNode);
    ...
    state.routes.map((route) => {
      ...
      return [
        route.key,
        {
          ...
          label: options.tabBarShowLabel === false
            ? undefined
            : options.tabBarLabel ?? ((props: MaterialLabelType) => renderLabel({ ...props, style: options.tabBarLabelStyle })),
          labelAllowFontScaling: options.tabBarAllowFontScaling,
          labelStyle: options.tabBarLabelStyle,
          labelText:
            options.tabBarShowLabel === false
              ? undefined
              : options.tabBarLabelText !== undefined
                ? options.tabBarLabelText
