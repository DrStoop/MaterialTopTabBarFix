...
export type MaterialTopTabNavigationOptions = {
   ...
   * 
   * If 'tabBarLabel' is undefined then 'tabBarLabelText' is rendered in default label 
   * component '<Text>{tabBarLabelText}</Text>'. If a 'tabBarLabel' component is provided
   * then 'tabBarLabelText' is passed as 'props.children' to the component.
   */
  tabBarLabelText?: string;

  /**
   * Function that given { focused: boolean, color: string } returns a React.Node, to display in tab bar.
   *
   * When undefined, scene title is used. Use `tabBarShowLabel` to hide the label.
   */
  tabBarLabel?:
