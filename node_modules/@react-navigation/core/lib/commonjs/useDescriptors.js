...
function useDescriptors({
  ...
  const render = (route, navigation, customOptions, routeState) => {
    ...
    screenLayout;
    let element = /*#__PURE__*/React.createElement(_SceneView.SceneView, {
    ...
    return /*#__PURE__*/React.createElement(_NavigationBuilderContext.NavigationBuilderContext.Provider, {
      key: route.key,
      value: context
