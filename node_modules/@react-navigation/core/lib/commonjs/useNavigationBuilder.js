  ...
  const configs = React.Children.toArray(children).reduce((acc, child) => {
    if ( /*#__PURE__*/React.isValidElement(child)) {
      ...
      if (child.type === React.Fragment || child.type === _Group.Group) {
        ...
        acc.push(...getRouteConfigsFromChildren(child.props.children, child.props.navigationKey, child.type !== _Group.Group ? groupOptions : groupOptions != null ? [...groupOptions, child.props.screenOptions] : [child.props.screenOptions], child.props.screenLayout ?? groupLayout));
        return acc;
      }
    }
...
function useNavigationBuilder(createRouter, options) {
  ...
  const NavigationContent = (0, _useComponent.useComponent)(children => {
    ...
    return /*#__PURE__*/React.createElement(_NavigationHelpersContext.NavigationHelpersContext.Provider, {
      value: navigation
    }, /*#__PURE__*/React.createElement(_PreventRemoveProvider.PreventRemoveProvider, null, element));
  });
  return {
    state,
    navigation,
