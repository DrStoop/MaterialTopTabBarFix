  ...
  const configs = React.Children.toArray(children).reduce((acc, child) => {
    if ( /*#__PURE__*/React.isValidElement(child)) {
      ...
      if (child.type === React.Fragment || child.type === Group) {
        ...
        acc.push(...getRouteConfigsFromChildren(child.props.children, child.props.navigationKey, child.type !== Group ? groupOptions : groupOptions != null ? [...groupOptions, child.props.screenOptions] : [child.props.screenOptions], child.props.screenLayout ?? groupLayout));
        return acc;
      }
    }
...
export function useNavigationBuilder(createRouter, options) {
  ...
  const NavigationContent = useComponent(children => {
    ...
    return /*#__PURE__*/React.createElement(NavigationHelpersContext.Provider, {
      value: navigation
    }, /*#__PURE__*/React.createElement(PreventRemoveProvider, null, element));
  });
  return {
    state,
    navigation,
